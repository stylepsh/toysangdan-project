...
const MEMBERS = [
  { id: 'M001', name: '김성호', store: '스타뽑기 강남점', phone: '010-1234-5678', email: 'star@naver.com', bizNo: '123-45-67890', grade: 'gold', joinDate: '2025-08-15', status: 'active', route: '네이버 검색', totalOrders: 24, totalAmount: 18500000, bizCertImage: 'https://picsum.photos/seed/biz1/300/400' },
  { id: 'M002', name: '이미영', store: '캐치미 홍대점', phone: '010-2345-6789', email: 'catchme@gmail.com', bizNo: '234-56-78901', grade: 'silver', joinDate: '2025-11-20', status: 'active', route: '카카오톡 광고', totalOrders: 12, totalAmount: 8200000, bizCertImage: 'https://picsum.photos/seed/biz2/300/400' },
  { id: 'M003', name: '박준혁', store: '행복뽑기', phone: '010-3456-7890', email: 'happy@naver.com', bizNo: '345-67-89012', grade: 'gold', joinDate: '2025-06-10', status: 'active', route: '도매꾹', totalOrders: 31, totalAmount: 24300000, bizCertImage: 'https://picsum.photos/seed/biz3/300/400' },
  { id: 'M004', name: '최수진', store: '럭키캐치 부산점', phone: '010-4567-8901', email: 'lucky@naver.com', bizNo: '456-78-90123', grade: 'silver', joinDate: '2026-01-05', status: 'active', route: '유튜브', totalOrders: 8, totalAmount: 5600000, bizCertImage: 'https://picsum.photos/seed/biz4/300/400' },
  { id: 'M005', name: '정태우', store: '토이박스 대구', phone: '010-5678-9012', email: 'toybox@gmail.com', bizNo: '567-89-01234', grade: 'bronze', joinDate: '2026-02-18', status: 'active', route: '인스타그램', totalOrders: 5, totalAmount: 3800000, bizCertImage: 'https://picsum.photos/seed/biz5/300/400' },
  { id: 'M006', name: '한소희', store: '뽑기천국 인천', phone: '010-6789-0123', email: 'heaven@naver.com', bizNo: '678-90-12345', grade: 'gold', joinDate: '2025-09-22', status: 'active', route: '지인 소개', totalOrders: 19, totalAmount: 15700000, bizCertImage: 'https://picsum.photos/seed/biz6/300/400' },
  { id: 'M007', name: '윤재석', store: '펀플레이 서울', phone: '010-7890-1234', email: 'funplay@gmail.com', bizNo: '789-01-23456', grade: 'bronze', joinDate: '2026-03-01', status: 'active', route: '네이버 블로그', totalOrders: 3, totalAmount: 1200000, bizCertImage: 'https://picsum.photos/seed/biz7/300/400' },
  { id: 'M008', name: '오영진', store: '프렌즈뽑기 수원', phone: '010-8901-2345', email: 'friends@naver.com', bizNo: '890-12-34567', grade: '', joinDate: '2026-03-28', status: 'pending', route: '카카오톡 오픈채팅', totalOrders: 0, totalAmount: 0, bizCertImage: 'https://picsum.photos/seed/biz8/300/400' },
  { id: 'M009', name: '강민수', store: '위너뽑기 광주', phone: '010-9012-3456', email: 'winner@gmail.com', bizNo: '901-23-45678', grade: '', joinDate: '2026-03-29', status: 'pending', route: '도매꾹', totalOrders: 0, totalAmount: 0, bizCertImage: 'https://picsum.photos/seed/biz9/300/400' },
];
